...
def test_wikipedia(monkeypatch):
    ...
    results = {
       "query": {
          ...
          "pages": {
             "16": {
                "extract":"L\u2019arc de triomphe de l\u2019\u00c9toile, souvent appel\u00e9 simplement l\u2019"
                          "Arc de triomphe, dont la construction, d\u00e9cid\u00e9e par l'empereur Napol\u00e9on Ier, "
                          "d\u00e9buta en 1806 et s'acheva en 1836 sous Louis-Philippe, est situ\u00e9 \u00e0 Paris, "
